# tt-produce-de — kein Prompt mehr hier

Der gültige Prompt für tt-produce (b59417b5583e) steht ausschließlich in
...
Anzeigen: `python -X utf8 -c "import json;[print(j['prompt']) for j in json.load(open('profiles/tiktok/cron/jobs.json',encoding='utf-8')) if j['name']=='tt-produce']"`
